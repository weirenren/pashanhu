    ...
    "domain_setting": [
        ...
        // },
        {
            ...
            url_array: [
                ...
                'https://www.douban.com/group/467221/discussion?start=0',
                'https://www.douban.com/group/hzhouse/discussion?start=0',
                'https://www.douban.com/group/551531/discussion?start=0',
                'https://www.douban.com/group/562889/discussion?start=0'
            ]
        },
        {
            dir_name: 'wuhan',
            city_name: '武汉',
            url_array: [
                'https://www.douban.com/group/134539/discussion?start=0',
                'https://www.douban.com/group/551524/discussion?start=0',
                'https://www.douban.com/group/352552/discussion?start=0',
                'https://www.douban.com/group/593360/discussion?start=0'
            ]
        },
        {
            dir_name: 'nanjing',
            city_name: '南京',
            url_array: [
                'https://www.douban.com/group/zf365/discussion?start=0'
            ]
        },
        {
            dir_name: 'tianjing',
            city_name: '天津',
            url_array: [
                'https://www.douban.com/group/69503/discussion?start=0',
                'https://www.douban.com/group/278229/discussion?start=0'
            ]
        },
        {
            dir_name: 'chongqing',
            city_name: '重庆',
            url_array: [
                'https://www.douban.com/group/CQrent/discussion?start=0',
                'https://www.douban.com/group/chengdu/discussion?start=0',
                'https://www.douban.com/group/601982/discussion?start=0',
                'https://www.douban.com/group/549038/discussion?start=0'
            ]
        }
        ]
};
